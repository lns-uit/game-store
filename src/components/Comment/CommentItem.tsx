...
function Comment({comment,updateCmtFunc,deleteCmtFunc,isOwn}: CommentParam) {
    const [likeCmts, setLikeCmts] = useState<LikeCommentType[]>([]);
    const [disLikeCmts, setDislikeCmts] = useState<LikeCommentType[]>([]);
    
    const getLikeComment = () => {
        return axios.get(Endpoint.mainApi + "api/likecomment/" + comment?.idComment)
            .then (res => {
                        ...
                        <Col xxl={16} xl={16} lg={16} md={16} sm={24} xs={24}>
                            ...
                            <div className="control-block">
                                ...
                                <div className="vote-btn d-flex gap-10">
                                    <div className="d-flex flex-center-x" onClick = {()=>{
