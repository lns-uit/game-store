  ...
  },
  {
    ...
    render: (text) => (
      <img
        ...
        src={
          text === null
            ? "https://firebasestorage.googleapis.com/v0/b/docprintx.appspot.com/o/logoSecondary.png?alt=media&token=d451278d-c524-46b5-a400-816b7970baa8"
            : text
        }
      />
    ),
...
function ConsoleUsersListScreen() {
  ...
  const getUserData = () => {
    return axios
      .get(Endpoint.mainApi + "api/user/" + start + "/" + count, {
        headers: {
  ...
  return (
    <div className="console-container">
      <Helmet>
        <title> Stun Console | Users </title>
      </Helmet>
